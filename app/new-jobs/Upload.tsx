      ...
      <table className="border border-dark_border text-dark_border font-normal">
        <thead>
          <tr className="border-b border-dark_border">
            ...
            <td className="p-3 text-base text-center ">from folder</td>
            <td className="py-3 px-4 border-x border-dark_border">
              <input type="checkbox" />
            </td>
            <td className="p-3 text-base text-center ">to folder</td>
          </tr>
        </thead>
        <tbody>
          <tr className="border-b border-dark_border">
